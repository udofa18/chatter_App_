const Features: React.FC = () => {
  ...
  return (
    <div className=" glass p-5 relative py-10">
      <div className="text-center text-3xl text-slate-200 px-40">
        <h5>Features</h5>
        <p className="text-center text-base m-10">
      ...
      <ul className="flex justify-between flex-nowrap  text-centre px-40  ">
