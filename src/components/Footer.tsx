...
const Footer = () => {
  ...
  return (
    <div>
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 relative">
  <div className="items-center grid-flow-col">
    ...
    <p>Chatter <br/> A multi-functional platform where authors and readers</p>
  </div> 
