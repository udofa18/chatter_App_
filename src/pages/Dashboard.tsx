...
useEffect(() => {
 ...
 navigate('/login')
  ...
  return (
    ...
    <div className=" relative top-7 left-0 hidden mob_dis_yes w-full  mt-10 ">
  <ul className="menu menu-horizontal bg-base-200 dark:text-slate-200 rounded-box  w-full">
  <li>
  ...
  <li>
    <NavLink to="analytics" className="tooltip" data-tip="Analytics">
    <svg
  ...
  <li>
    <NavLink to="bookmarks" className="tooltip" data-tip="Bookmarks" >
  ...
  <li>
    <Link to="#" className="tooltip" data-tip="Log-out" onClick={userSignout}>
  ...
  <div className="flex">
      <aside className="flex no_dis flex-col w-100 h-screen px-5 py-5  bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
      <div
        style={{ }}
      ...
      >
        <img
          ...
          className=" m-auto p-2
            "
        />
       <p className="text-gray-500 font-bold text-center"> {greeting}<br/>{authUser.displayName}</p>
      </div>
          ...
          <nav className="-mx-3 space-y-6 ">
            ...
            <div className="space-y-3 ">
              ...
              >
                ...
                <span onClick={userSignout} className="mx-2 text-sm font-medium">Logout</span>
              </a>
            </div>
          </nav>
        </div>
      ...
      <div className="  w-screen justify-between p-5 mob_width p_0  mar_top  ">
      <Outlet/>
      </div>
      </div>
    </div>
